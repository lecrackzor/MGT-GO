...
> implements ISeriesCustomPaneView {
	...
	protected override _convertToCoordinates(
		...
		// Update x for all items, not just the visible range. Otherwise segment endpoints that just
		// moved off-screen keep their last on-screen x and stack at the left/right edge.
		timeScale.indexesToCoordinates(this._items, undefined);
	}
